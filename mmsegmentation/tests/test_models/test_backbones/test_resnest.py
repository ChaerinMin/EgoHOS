...
from submodules.EgoHOS.mmsegmentation.mmseg.models.backbones import ResNeSt
from submodules.EgoHOS.mmsegmentation.mmseg.models.backbones.resnest import Bottleneck as BottleneckS
