...
from submodules.EgoHOS.mmsegmentation.mmseg.models.backbones.mit import EfficientMultiheadAttention
from submodules.EgoHOS.mmsegmentation.mmseg.models.builder import BACKBONES
...
class GlobalSubsampledAttention(EfficientMultiheadAttention):
    ...
    which is a module from submodules.EgoHOS.mmsegmentation.mmseg.models.backbones.mit.py.
